...
#[derive(Debug)]
pub struct MockProviderProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MockProviderProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MockProvider processing");
    
    let mut processor = MockProviderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MockProviderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MockProviderProcessor::new(false);
